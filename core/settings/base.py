...
THIRD_PARTY_APPS = [
    "django_extensions",
    "django_filters",
    # Cloudinary removido - agora usando Supabase Storage exclusivamente
]
...
# Cloudinary removido - usando Supabase Storage exclusivamente
# Ver fiscal/services/storage.py para gerenciamento de imagens
